...
Module of **Low-level programming** and **algorithm**, i will be working on during **Full Stack Software Engineering studies** at ALX
...
## Projects
All of the following folders are projects ill be working on during the studies:
...
#
**This repository contains programs written for the low-level programming and algorithm track at Alx software engineering Holberton School curricullum. In these projects, which will occur throughout the duration of my studies through the curriculum, I will learn about data structures, algorithms, and other low-level programming concepts while working in the C language.**
##
...
All work contained in this project will be completed as part of the Alx software Engineering curriculum of Holberton School. Alx, full-stack software engineering program that prepares students for careers in the tech industry using project-based peer learning.
